        ...
        <>
            ...
            <main className="flex flex-col mt-20 ">
                <section className="flex bg-white h-screen">
                    <div className="p-36 pl-72 w-7/12 text-secundary">
                        ...
                        <button className="bg-secundary text-white p-3 rounded-md mt-8">Criar uma conta</button>
                    </div>
                ...
                <section className="flex">
                    <div className="p-36 pl-72 w-7/12 text-black">
                        ...
                        <button className="bg-secundary text-white p-3 rounded-md mt-8">Conheça nossa empresa!</button>
                    </div>
                ...
                <section className="flex">
                    ...
                    <div className="p-36 w-7/12 text-black">
                        <h1 className="text-5xl font-bold text-secundary">A Parceira certa para seu negócio!</h1>
                        ...
                        <button className="bg-secundary text-white p-3 rounded-md mt-8">Gerencie sua loja!</button>
                    </div>
                </section>
                <section className="flex flex-col justify-center h-screen bg-white_opacity">
                    <div className="flex flex-col items-center">
                        ...
                        <h1 className="text-4xl mt-8 font-bold text-secundary">Lojas do mundo todo estão aqui. Esperando por você!</h1>
                        <Carousel />
                    </div>
                </section>
                <section className="flex">
                    <div className="p-36 pl-72 w-7/12 text-black">
                        <h1 className="text-5xl font-bold text-secundary">Seja um entregador!</h1>
                        ...
                        <button className="bg-secundary text-white p-3 rounded-md mt-8">Seja um entregador!</button>
                    </div>
