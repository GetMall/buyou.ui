            ...
            <div className="flex flex-wrap gap-5">
              {shopping.map((shopping) => (
                <Card
                  ...
                  key={shopping.id}
                  nomeLoja={shopping.nome}   
                  imgLoja={`http://52.72.53.170/api/midias/imagens/${shopping.imagens?.nomeArquivoSalvo}`}
                />
              ))}
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-5">
              {loja.map((loja) => (
                <Card
                  ...
                  key={loja.id}
                  nomeLoja={loja.nome}
                  imgLoja={`http://52.72.53.170/api/midias/imagens/${loja.imagens[0]?.nomeArquivoSalvo}`}
                />
              ))}
            </div>
          </div>
