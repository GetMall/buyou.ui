      ...
      <main className="flex flex-col">
        <section className="flex">
          <div className="flex flex-col mt-52 w-full justify-center items-center absolute"> 
            ...
            <p>Para o consumidor de aplicativos de compras online, que possui a necessidade da entrega imediata de determinados produtos, e precisa de uma plataforma que facilite e agilize esse processo, que proporciona comodidade e praticidade.</p>
            </div>
