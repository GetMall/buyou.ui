                                ...
                                <>
                                    <form onSubmit={handleSubmit(cadastrar)}>
                                        ...
                                        <div className='flex flex-col w-96 gap-5'>
                                            <input {...register("nome")} className='outline-none p-2  border-b_gray border-2' type="text" placeholder='Informe seu nome de usuário' />
                                            <input {...register("email")} className='outline-none p-2 border-b_gray border-2' type="text" placeholder='Informe seu Email' />
