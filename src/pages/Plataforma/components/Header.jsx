...
function Header({ onClick, endereco, atualizarProduto }) {
        ...
        <div className="flex items-center mx-auto gap-5">
          ...
          <div className={`flex gap-5 cursor-pointer w-28 rounded-3xl justify-center p-2 ${carrinhoItens.length > 0 ? "bg-primary" : ""}`}>
            {carrinhoItens.length > 0 ? (
              <>
                <div onClick={() => navigate("/carrinho")} className="flex gap-2">
                  <img
                    src={cartAddProduto}
              ...
              <>
                <div onClick={() => navigate("/carrinho")} className="flex gap-2 cursor-pointer">
                  <img
                    src={cart}
                    alt=""
                    className="w-6"
